    ...
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", minHeight: "100vh", background: "#fff", overflowX: "hidden" }}>
      ...
      <nav className="landing-nav" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 38, height: 38, background: "linear-gradient(135deg,#2f9e5c,#12492b)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 }}>🌿</div>
          <div>
        ...
        <div className="landing-nav-links" style={{ alignItems: "center", gap: 28 }}>
          {[{ label: "Inicio", id: "inicio" }, { label: "Funciones", id: "funciones" }, { label: "Nosotros", id: "nosotros" }, { label: "Contacto", id: "contacto" }].map(({ label, id }) => (
            <span key={id} onClick={() => scrollTo(id)} style={{ color: "rgba(255,255,255,0.75)", fontSize: 13, fontWeight: 500, cursor: "pointer" }}
              onMouseEnter={e => e.target.style.color = "#2f9e5c"}
      ...
      <div id="funciones" className="landing-section" style={{ background: "#f4f6f5" }}>
        <div style={{ textAlign: "center", marginBottom: 70 }}>
          ...
          <p style={{ fontSize: 15, color: "#4c6b5a", maxWidth: 560, margin: "0 auto" }}>Caribe Bloom integra tecnología satelital, inteligencia artificial y monitoreo en tiempo real en una sola plataforma.</p>
        </div>
        <div className="landing-grid-3" style={{ gap: 24, maxWidth: 1100, margin: "0 auto" }}>
          {[
            ...
            <div key={title} style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.07)", borderRadius: 16, padding: "32px 28px", boxShadow: "0 2px 12px rgba(0,0,0,0.05)", display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ width: 52, height: 52, background: "linear-gradient(135deg,#e2f0e7,#c3ddc9)", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 26 }}>{icon}</div>
              <div>
      ...
      <div id="nosotros" className="landing-section" style={{ background: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 70, position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontSize: 15, color: "#4c6b5a", maxWidth: 520, margin: "0 auto", lineHeight: 1.65 }}>Un equipo comprometido con llevar la tecnología agrícola de precisión al corazón del Caribe colombiano.</p>
        </div>
        ...
        <div className="landing-grid-2" style={{ gap: 28, maxWidth: 1000, margin: "0 auto 64px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ background: "#f4f6f5", borderRadius: 20, padding: "44px 40px", position: "relative", overflow: "hidden", border: "1px solid rgba(47,158,92,0.15)" }}>
            ...
            <p style={{ fontSize: 13.5, color: "#4c6b5a", lineHeight: 1.8, margin: 0 }}>En Caribe Bloom, democratizamos el acceso a la agricultura de precisión con inteligencia artificial, visión computacional y datos satelitales.</p>
          </div>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto", background: "#fff", borderRadius: 16, padding: "40px 36px", boxShadow: "0 2px 20px rgba(0,0,0,0.06)" }}>
          {[{ label: "Nombre completo", placeholder: "Tu nombre", type: "text" }, { label: "Correo electrónico", placeholder: "tu@correo.com", type: "email" }].map(({ label, placeholder, type }) => (
            <div key={label} style={{ marginBottom: 18 }}>
              <label style={{ fontSize: 12, fontWeight: 600, color: "#071f14", display: "block", marginBottom: 6 }}>{label}</label>
          ...
          <button style={{ width: "100%", padding: "13px", background: "#2f9e5c", border: "none", borderRadius: 8, color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>Enviar mensaje →</button>
        </div>
